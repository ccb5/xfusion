...
#define XF_BITMAP8_GET_BLK_POS(_bitmap, _bit)           ((_bit) / (sizeof(xf_bitmap8_t) * 8))
#define XF_BITMAP8_GET_BIT_POS_IN_BLK(_bitmap, _bit)    ((_bit) % (sizeof(xf_bitmap8_t) * 8))
#define XF_BITMAP8_GET_BLK(_bitmap, _bit)               (_bitmap[XF_BITMAP8_GET_BLK_POS(_bitmap, _bit)])
#define XF_BITMAP8_GET_BIT_POS(_bitmap, _bit)           ((xf_bitmap8_t)1 << XF_BITMAP8_GET_BIT_POS_IN_BLK(_bitmap, _bit))
...
#define XF_BITMAP8_GET_MDF(_bitmap, _bit, _value)       (XF_BITMAP8_GET_MDF0(_bitmap, _bit) | ((xf_bitmap8_t)(!!(_value)) << XF_BITMAP8_GET_BIT_POS_IN_BLK(_bitmap, _bit)))
...
#define XF_BITMAP16_GET_BLK_POS(_bitmap, _bit)          ((_bit) / (sizeof(xf_bitmap16_t) * 8))
#define XF_BITMAP16_GET_BIT_POS_IN_BLK(_bitmap, _bit)   ((_bit) % (sizeof(xf_bitmap16_t) * 8))
#define XF_BITMAP16_GET_BLK(_bitmap, _bit)              (_bitmap[XF_BITMAP16_GET_BLK_POS(_bitmap, _bit)])
#define XF_BITMAP16_GET_BIT_POS(_bitmap, _bit)          ((xf_bitmap16_t)1 << XF_BITMAP16_GET_BIT_POS_IN_BLK(_bitmap, _bit))
...
#define XF_BITMAP16_GET_MDF(_bitmap, _bit, _value)      (XF_BITMAP16_GET_MDF0(_bitmap, _bit) | ((xf_bitmap16_t)(!!(_value)) << XF_BITMAP16_GET_BIT_POS_IN_BLK(_bitmap, _bit)))
...
#define XF_BITMAP32_GET_BLK_POS(_bitmap, _bit)          ((_bit) / (sizeof(xf_bitmap32_t) * 8))
#define XF_BITMAP32_GET_BIT_POS_IN_BLK(_bitmap, _bit)   ((_bit) % (sizeof(xf_bitmap32_t) * 8))
#define XF_BITMAP32_GET_BLK(_bitmap, _bit)              (_bitmap[XF_BITMAP32_GET_BLK_POS(_bitmap, _bit)])
#define XF_BITMAP32_GET_BIT_POS(_bitmap, _bit)          ((xf_bitmap32_t)1 << XF_BITMAP32_GET_BIT_POS_IN_BLK(_bitmap, _bit))
...
#define XF_BITMAP32_GET_MDF(_bitmap, _bit, _value)      (XF_BITMAP32_GET_MDF0(_bitmap, _bit) | ((xf_bitmap32_t)(!!(_value)) << XF_BITMAP32_GET_BIT_POS_IN_BLK(_bitmap, _bit)))
...
#define XF_BITMAP64_GET_BLK_POS(_bitmap, _bit)          ((_bit) / (sizeof(xf_bitmap64_t) * 8))
#define XF_BITMAP64_GET_BIT_POS_IN_BLK(_bitmap, _bit)   ((_bit) % (sizeof(xf_bitmap64_t) * 8))
#define XF_BITMAP64_GET_BLK(_bitmap, _bit)              (_bitmap[XF_BITMAP64_GET_BLK_POS(_bitmap, _bit)])
#define XF_BITMAP64_GET_BIT_POS(_bitmap, _bit)          ((xf_bitmap64_t)1 << XF_BITMAP64_GET_BIT_POS_IN_BLK(_bitmap, _bit))
...
#define XF_BITMAP64_GET_MDF(_bitmap, _bit, _value)      (XF_BITMAP64_GET_MDF0(_bitmap, _bit) | ((xf_bitmap64_t)(!!(_value)) << XF_BITMAP64_GET_BIT_POS_IN_BLK(_bitmap, _bit)))
...
#define XF_BITMAP_GET_BLK_POS(_bitmap, _bit)            XCAT3(XF_BITMAP, XF_BITMAP_BLK_SIZE, _GET_BLK_POS) ((_bitmap), (_bit))
#define XF_BITMAP_GET_BIT_POS_IN_BLK(_bitmap, _bit)     XCAT3(XF_BITMAP, XF_BITMAP_BLK_SIZE, _GET_BIT_POS_IN_BLK) ((_bitmap), (_bit))
