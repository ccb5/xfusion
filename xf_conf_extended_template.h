 ...
 *       包含 XF_CONF_EXTENDED_PATH 。因此 `xf_conf.h` 内定义的宏可以直接使用。
 *
 * @note 此文件主要用于编写 Kconfig 无法覆盖的配置，例如：带参宏。
 */

/*
 * Copy this file as `xf_conf_extended.h`
...
#ifndef __XF_CONF_EXTENDED_H__
#define __XF_CONF_EXTENDED_H__
...
#endif /* XF_ENABLE_SAFE */

#endif /* __XF_CONF_EXTENDED_H__ */
