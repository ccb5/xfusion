...
//  <i> Default: 128
#define configMINIMAL_STACK_SIZE                  ( ( StackType_t ) ( 0x4000 + 40 ) / sizeof( StackType_t ) ) /* ((uint16_t)(128)) */
...
//  <i> Default: 1000
#define configTICK_RATE_HZ                        ( ( TickType_t ) CONFIG_FREERTOS_HZ ) /* ((TickType_t)1000) */
